...
import 'package:securing_emirates/ui/screens/regularizescreen.dart';
...
//   print("getregularizationId : $postData");
...
//       List<String> newIds =
//           response.data.map((r) => r.internalId.toString()).toList();
...
//       });
//     } else {
//       print("⚠️ No regularization records available.");
//       setState(() => isLoading = false);
//     }
//   } catch (e) {
//     setState(() => isLoading = false);
...
// //getsingleregularizationlist
// Future<Map<String, dynamic>?> getsingleregularizationlist(ti) async {
//   if (widget.timesheetId == null || widget.timesheetId!.isEmpty) {
//     showInSnackBar(context, "❌ timesheetId not found!");
//     return null;
//   }

//   final Map<String, dynamic> postData = {"timesheetId": widget.timesheetId};
//   print("➡️ singleregularizationlist request: $postData");

//   setState(() => isLoading = true);

//   try {
//     final result = await apiService.singleregularizationlist(postData);

//     if (result.body.isEmpty) {
//       print("⚠️ API returned empty body");
//       setState(() => isLoading = false);
//       return null;
//     }
...
//     final response = GetsingleregularizationlistModel.fromJson(decoded);

//     if (response.data != null && response.data.isNotEmpty) {
//       print("✅ Got single regularization: ${response.data[0]}");
//       return response.data[0]; // return first record
//     } else {
//       print("⚠️ No regularization data found");
//       return null;
//     }
//   } catch (e, stack) {
//     setState(() => isLoading = false);
//     print("❌ Error in getsingleregularizationlist: $e\n$stack");
//     showInSnackBar(context, "Error: $e");
//     return null;
//   }
// }
...
//         regularizationList = allData; // reset list
//       });
//     }
//   }
...
//                                       //                 const SizedBox(height: 8),
//                                       //                 Text(
//                                       //                     "⏱ Hours Worked: ${formatWorkingTimeSmart(e.hoursWorked)}"),
//                                       //                 const SizedBox(height: 8),
//                                       //                 Text(
//                                       //                     "📝 Status: ${e.reqstatus}"),
//                                       //               ],
...
//           future: getsingleregularizationlist(),
...
//                 content: const Text("No regularization details found."),
//                 actions: [
//                   TextButton(
//                     onPressed: () => Navigator.pop(context),
//                     child: const Text("Close"),
...
//                 children: [
//                   Text("📅 Date: ${data['attendanceDate'] ?? '-'}"),
//                   const SizedBox(height: 8),
//                   Text("🕒 Time In: ${data['timeIn'] ?? '-'}"),
//                   const SizedBox(height: 8),
//                   Text("🕔 Time Out: ${data['timeOut'] ?? '-'}"),
//                   const SizedBox(height: 8),
//                   Text("⏱ Hours Worked: ${data['hoursWorked'] ?? '-'}"),
//                   const SizedBox(height: 8),
//                   Text("📝 Status: ${data['reqstatus'] ?? '-'}"),
//                 ],
//               ),
//               actions: [
//                 TextButton(
...
//       if (response.data.isNotEmpty) {
//         List<String> newIds = response.data
//             .map((r) => r.internalId.toString())
//             .toList();
...
//     print("singleregularizationlist : $postData");
//     setState(() => isLoading = true);
...
//                                                 ),
//                                                 onPressed: () async {
//                                                   // ✅ Capture safe context BEFORE await
...
//                                                   if (!mounted)
//                                                     return; // ✅ ensure widget still alive
...
//                                                   // ✅ Use Get.dialog (no disposed context issue)
//                                                   Get.dialog(
//                                                     AlertDialog(
//                                                       shape: RoundedRectangleBorder(
//                                                         borderRadius:
...
//                                                           ),
//                                                           Text(
//                                                             "📌 Sales Order: ${singleData['salesOrder'] ?? '-'}",
//                                                           ),
//                                                         ],
//                                                       ),
//                                                       actions: [
...
//             // ✅ Only From selected → after FromDate
//             dateMatch =
//                 date.isAtSameMomentAs(fromDate!) || date.isAfter(fromDate!);
//           } else if (toDate != null) {
//             // ✅ Only To selected → before ToDate
//             dateMatch =
//                 date.isAtSameMomentAs(toDate!) || date.isBefore(toDate!);
//           }
//         } catch (_) {
