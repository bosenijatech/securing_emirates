...
//   const Homepage({super.key, required this.employeeName});
...
//       status = "Leave"; // ✅ Mark leave
//     } else if (day.weekday == DateTime.saturday || day.weekday == DateTime.sunday) {
//       status = "Weekend";
//     } else if (clockIn == '-') {
//       status = "Absent";
//     } else {
//       // ✅ Late logic: shift 9:00 AM
//       DateTime shiftStart = DateTime(day.year, day.month, day.day, 9, 0);
//       DateTime actualIn = parseTime(clockIn, day);
...
//     case 'Future':
//       return const Color.fromARGB(255, 208, 220, 214).withOpacity(0.1); // grey
//     case 'Weekend':
...
//   // bottomsheet open only for Present
//   void tryOpenBottomSheet(BuildContext context, DateTime selectedDay) {
//     final attData = monthlyData.firstWhere(
//       (d) =>
//           d['date'].day == selectedDay.day &&
//           d['date'].month == selectedDay.month &&
...
// void onDateTap(Map<String, dynamic>? data) {
//   setState(() {
//     _selectedData = data;
//   });
// }
...
//                         onTap: () {
//                           Get.to(
//                             () => Profilescreen(employeeName: employeeName),
//                           );
//                         },
//                         child: CircleAvatar(
//                           radius: 25,
...
//                           context,
//                           MaterialPageRoute(
//                             builder: (context) => Employeereportspage(timesheetId : lastSalesOrderId),
//                           ),
//                         );
//                       },
//                       child: Container(
...
//     print("📌 Selected: $_selectedDay → Status: ${_selectedData!['status']}");
//   });
// },
...
//                   //   _focusedDay = focusedDay;
//                   //   getMonthlyAttendanceForMonth(focusedDay);
//                   // },
...
//         defaultSelectedDay = DateTime(focusedDay.year, focusedDay.month, 1);
//       }
...
//                       Text(
//                         'Absent',
//                         style: TextStyle(color: AppColor.sec_red),
//                       ),
//                     ],
//                   ),
//                   SizedBox(height: 16),
...
//         const SnackBar(content: Text("Cannot open details for Future day")),
//       );
//     }
//   },
//   child: Container(
...
//                 fontWeight: FontWeight.bold,
//                 fontSize: 16,
//                 color: getStatusColor(getDisplayStatus(_selectedData)),
//               ),
//             ),
//           ],
//         ),
...
List<Map<String, dynamic>> buildMonthlyAttendanceWithDefaults() {
  ...
  for (var day in allDays) {
    var att = monthlyattendance.firstWhere(
      ...
      orElse: () => Attendance(
        ...
        otHours: "0:00",
        attendanceStatus: null,
        shiftMaster: null, // add shiftMaster field in your model if not already
      ),
    );
    ...
    if (att.shiftMaster?.toString() == "2") {
      ...
      shiftEnd = DateTime(day.year, day.month, day.day + 1, 5, 0); // next day 5 AM
    } else {
  ...
  onTap: () {
    if (_selectedData != null &&
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Cannot open details for this day")),
      );
    }
  },
  child: Container(
