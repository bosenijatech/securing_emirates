...
// //     print("🔄 Sales order fetch started...");

// //     try {
// //       Response result = await apiService.getsalesorderNo();
// //       print("📩 Response received with status: ${result.statusCode}");
...
// //         });
// //         print("✅ Sales order list updated: ${salesorderlist.length} items");
// //       } else {
// //         print("⚠️ API success=false → ${response.message}");
// //         setState(() => salesorderlist = []);
// //       }
// //     } catch (e, s) {
// //       print("❌ Exception in getsalesorderNo: $e");
// //       print("🛑 Stacktrace: $s");
// //     } finally {
// //       setState(() => isLoading = false);
// //       print("🏁 Sales order fetch finished. isLoading=$isLoading");
// //     }
// //   }
...
// //       // Convert current location to Google Maps URL
// //       String gpsAddress = getGoogleMapsUrl(_currentLatLng);
...
// //       print('📩 Raw result: ${result.body}');

// //       Map<String, dynamic> data = json.decode(result.body);

// //       if (data['status'] == true) {
// //         String message = data['message'] ?? "Timesheet added successfully";

// //         await prefs.setString("shiftId", shiftId.toString());
// //         await prefs.setBool("isCheckedIn", true);

// //         showInSnackBar(context, "✅ $message");
// //         return true;
// //       } else {
// //         showInSnackBar(
// //           context,
...
// //       print("Google Maps URL: ${getGoogleMapsUrl(latLng)}");
// //     } catch (e) {
...
// //               onChanged: (value) => setState(() => usershift = value),
...
//   Set<int> disabledShiftIds = {}; // shifts already checked in today
...
//       // Check if this shift already checked in today
//       bool alreadyCheckedIn = await hasCheckedInToday(shiftId);
//       if (alreadyCheckedIn) {
//         showInSnackBar(
//             context, "❌ You have already checked in for $usershift today.");
//         return false;
//       }
