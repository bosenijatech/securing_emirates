...
//     print("🚀 addRegularization started");

//     if (noteController.text.trim().isEmpty) {
//       print("⚠️ Note is empty");
...
//     try {
//       // Debug TimeOfDay
//       print("⏰ checkInTime: ${checkInTime.hour}:${checkInTime.minute}");
//       print("⏰ checkOutTime: ${checkOutTime.hour}:${checkOutTime.minute}");
//       print("📌 API Date: $apiDate");

//       // Format times for API
//       String timeIn = formatTimeOfDay24(checkInTime);
//       String timeOut = formatTimeOfDay24(checkOutTime);
//       print("🕒 Formatted Time In: $timeIn, Time Out: $timeOut");

//       // Build DateTime objects for in/out
...
//         checkOutTime.minute,
//       );
//       print("📅 inDateTime: $inDateTime, outDateTime: $outDateTime");
...
//         print("⏩ outDateTime adjusted to next day: $outDateTime");
//       }
...
//       print("⏱ Hours Worked (decimal): $hoursWorkedDecimal");
...
//       print("📝 Shift Master ID: $shiftMasterId");
...
//       print('📥 API Response Raw: ${result.body}');
...
//         print('⚠️ JSON Decode Failed, fallback message: ${result.body}');
//       }
...
//           if (mounted) Get.back(result: true); // list will refresh
//           print("🔙 Get.back called to refresh list");
//         });
//       } else {
//         print('❌ Failed to add: ${response.message}');
//         ScaffoldMessenger.of(context).showSnackBar(
...
//     print("🏁 addRegularization finished");
//   }
